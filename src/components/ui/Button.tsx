...
const variantStyles: Record<Variant, string> = {
  primary:
    "bg-gradient-to-r from-primary to-primary-light text-white shadow-lg shadow-primary/20 hover:shadow-[0_0_20px_rgba(168,85,247,0.4),0_0_40px_rgba(168,85,247,0.2)] hover:brightness-110 hover:scale-105",
  secondary:
